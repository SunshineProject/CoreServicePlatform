 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addUserClaimValues",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addUserClaimValues",
    ...
    public static class Factory{
        ...
        */
        public static AddUserClaimValues parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddUserClaimValues object =
                new AddUserClaimValues();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addUserClaimValues".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddUserClaimValues)org.wso2.carbon.um.ws.service.dao.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
